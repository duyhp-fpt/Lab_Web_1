 ...
 private static final String SUCCESS = "AdminController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dtos != null && "AD".equals(dtos.getRoleID())){
                String txtProductID = request.getParameter("productID");
                ProductDAO.DeleteProduct(txtProductID, dtos.getUserID());
                request.setAttribute("MESSAGE", "Delete product sucess.");
                url = SUCCESS;
            }else{
                url = LOGOUT;
            }
        } catch (Exception e) {
            Logger.getLogger(DeleteProductController.class.getName()).error(e.toString());
        }finally{
